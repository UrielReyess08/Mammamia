...
<html>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                      ...
                      %>
                      <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/customer/logout.jsp">Iniciar Sesión (Invitado) <span class="sr-only">(current)</span></a>
                      </li>
                      <%
                            } else {
                        %>
        ...
        <div class="container">
            <h1 class="mt-5 mb-4">Preguntas Frecuentes</h1>
            ...
            <div class="accordion" id="accordionExample">
              ...
              <div class="card">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                  <div class="card-body">
                    Nuestro horario de entrega es de 11:00 AM a 10:00 PM todos los días de la semana.
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                  <div class="card-body">
                    El tiempo de entrega promedio es de 30 a 45 minutos, dependiendo de la ubicación y el tráfico.
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                  <div class="card-body">
                    Sí, ofrecemos una variedad de opciones vegetarianas que incluyen pizzas con vegetales frescos y ensaladas.
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                  <div class="card-body">
                    Sí, ofrecemos opciones sin gluten en nuestro menú. Por favor, especifique sus necesidades dietéticas al realizar el pedido.
                  </div>
                </div>
              </div>
            </div>
