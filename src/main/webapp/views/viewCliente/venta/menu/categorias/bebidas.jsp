<%-- 
    Document   : bebidas
    Created on : 6 ene. 2024, 16:17:19
    Author     : daiko
--%>
        ...
        <main>
            ...
            <article class="...">
                ...
                <section>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_bebida_2">
                        <div class="card-body">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_bebida_3">
                        <div class="card-body">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_bebida_4">
                        <div class="card-body">
                            <h5 class="card-title">Bebida 4</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_bebida_5">
                        <div class="card-body">
                            <h5 class="card-title">Bebida 5</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_bebida_6">
                        <div class="card-body">
                            <h5 class="card-title">Bebida 6</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
