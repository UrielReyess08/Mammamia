            ...
            <article class="...">
                ...
                <section>
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_pasta_1">
                        <div class="card-body">
                            <h5 class="card-title">Pasta 1</h5>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_pasta_2">
                        <div class="card-body">
                            <h5 class="card-title">Pasta 2</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_pasta_3">
                        <div class="card-body">
                            <h5 class="card-title">Pasta 3</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_pasta_4">
                        <div class="card-body">
                            <h5 class="card-title">Pasta 4</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_pasta_5">
                        <div class="card-body">
                            <h5 class="card-title">Pasta 5</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_pasta_6">
                        <div class="card-body">
                            <h5 class="card-title">Pasta 6</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
