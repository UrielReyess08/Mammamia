<%-- 
    Document   : postres
    Created on : 6 ene. 2024, 16:17:41
    Author     : daiko
--%>
            ...
            <article class="...">
                ...
                <section>
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_postre_1">
                        <div class="card-body">
                            <h5 class="card-title">Postre 1</h5>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_postre_2">
                        <div class="card-body">
                            <h5 class="card-title">Postre 2</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_postre_3">
                        <div class="card-body">
                            <h5 class="card-title">Postre 3</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_postre_4">
                        <div class="card-body">
                            <h5 class="card-title">Postre 4</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_postre_5">
                        <div class="card-body">
                            <h5 class="card-title">Postre 5</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="..." alt="img_postre_6">
                        <div class="card-body">
                            <h5 class="card-title">Postre 6</h5>
                            <p class="card-text">Precio</p>
                            <a href="#" class="btn btn-primary">Añadir Producto</a>|
                            <a href="../../pago/carritoCompras.html">Ver Carrito</a>
                        </div>
